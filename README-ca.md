...
La fluïdesa a la línia de comandament és una habilitat sovint descuidada o considerada arcana, però millora la vostra flexibilitat i productivitat com a enginyer/a tant de manera òbvia com subtil. Aquesta és una selecció de notes i consells sobre l'ús de la línia d'ordres que hem trobat útil quan treballem en Linux. Alguns consells són elementals, i alguns són força específics, sofisticats o foscs. Aquesta pàgina no és llarga, però si podeu utilitzar i recordar tots els elements aquí, en sabreu molt.
